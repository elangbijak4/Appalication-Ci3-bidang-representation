...
<head>
    <title>UPT PPK BKD Provinsi Sulawesi Selatan</title>
    <!-- Meta-Tags -->
...
<section class="main">
	<div class="layer">
		...
		<div class="bottom-grid">
			<div class="logo">
				<h1> <img src="<?php echo base_url('/assets/images/logo_sulsel.png');?>" class="logo_sulsel" style="float:left;margin-right:10px;" /><a href="index.php"><span class="text-login" style="font-size:20px;">e-Office BKD Prov. Sulsel</span></a></h1>
			</div>
			<div class="links" >
		...
		<div class="content-w3ls">
			<div class="text-center icon">
				<span class="text-login" style="font-size:25px;">UPT PPK BKD Sulawesi Selatan</span>
			</div>
			<div class="content-bottom">
				<form action="<?php echo site_url('login/login/process') ?>" method="post" accept-charset="utf-8">
					...
					<div class="wthree-field">
						<button type="submit" class="btn"><span style="font-size:15px">Masuk Admin UPT PPK</span></button>
					</div>
					<ul class="list-login">
