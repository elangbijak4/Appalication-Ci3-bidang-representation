...
class Viewfrommyframework {
    ...
    //===========================================#13-12-2020======================================================================================
    function penampil_tabel_no_foto_untuk_surat_masuk_frontoffice_surat_masuk_verifikasi_ditolak ($kolom_cari,$nama_kolom_direktori_surat,$array_atribut,$query_yang_mau_ditampilkan,$submenu,$kolom_direktori='direktori',$direktori_avatar='/public/img/no-image.jpg'){
                ...
                foreach($Recordset as $keyisi=>$isi){
                    if($isi['status_surat']=='ditolak'){
                        ...
                        */
                        ...
                        <button class=\"d-sm-inline-block btn btn-sm btn-success shadow-sm kotak\" style=\"width:33%;margin-top:5px;\" id=\"isiSurat$keyisi\" data-toggle=\"modal\" data-target=\"#modal_baca_surat_new\"><i class='fas fa-envelope-open fa-sm text-white-100'></i> <br>Buka Surat</button>
                        <button class=\"d-sm-inline-block btn btn-sm btn-info shadow-sm kotak\" style=\"width:33%;margin-top:5px;\" id=\"berkasSurat$keyisi\" data-toggle=\"modal\" data-target=\"#modal_baca_surat_new\"><i class='fas fa-folder-open fa-sm text-white-100'></i> <br>Berkas Pendukung</button>
                        <button class=\"d-sm-inline-block btn btn-sm btn-info shadow-sm kotak\" style=\"width:33%;margin-top:5px;\" id=\"detail_surat$keyisi\" ><i class='fas fa-cog fa-sm text-white-100'></i> <br>Detail</button><!--
    ...
    function penampil_tabel_no_foto_untuk_surat_masuk_frontoffice_surat_masuk_verifikasi ($kolom_cari,$nama_kolom_direktori_surat,$array_atribut,$query_yang_mau_ditampilkan,$submenu,$kolom_direktori='direktori',$direktori_avatar='/public/img/no-image.jpg'){
        ...
        if (!$Recordset1) {
            ...
            if(isset($Recordset[0])){
                ...
                $i=0;
                foreach($Recordset as $keyisi=>$isi){
                    if($isi['status_surat']!='selesai'&&$isi['status_surat']!='ditolak'){
                        $enkrip_isi=$this->CI->enkripsi->enkapsulasiData($isi);
                        echo "<tr>";
                        //$tampung=array_values($isi); 
                        $i++;
    ...
    function penampil_tabel_no_foto_untuk_surat_masuk_frontoffice_surat_masuk_verifikasi_selesai ($kolom_cari,$nama_kolom_direktori_surat,$array_atribut,$query_yang_mau_ditampilkan,$submenu,$kolom_direktori='direktori',$direktori_avatar='/public/img/no-image.jpg'){
        $Recordset1=$this->CI->model_frommyframework->user_defined_query_model($query_yang_mau_ditampilkan,$token='andisinra');
        //var_dump($Recordset1);
        if (!$Recordset1) {
            echo "<center>TABEL YANG BERSESUAIAN KOSONG, SILAHKAN DIISI DULU</center>";
    ...
    //===========================================END TAMBAHAN KHUSUS UNTUK CRUID VERIFIKASI PERBAIKAN=======================================
